...
{
    public class CDDMenuRenderer : ToolStripProfessionalRenderer
    {
        //Fields
        ...
        //Constructor
        public CDDMenuRenderer(bool isMainMenu, Color primaryColor, Color textColor)
            : base(new CDDMenuColorTable(isMainMenu, primaryColor))
        {
